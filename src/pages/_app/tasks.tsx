      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Dialog.Root open={open} onOpenChange={setOpen}>
          <Dialog.Trigger asChild>
            <Button type="button" className="h-11 rounded-2xl px-5" onClick={openCreate}>
              ...
              <form
                ...
                onSubmit={form.handleSubmit((values) => {
                  ...
                  if (durationMinutes <= 0) {
                    form.setError("duration", { type: "validate", message: "Duration must be > 00:00" })
                    return
                  }

                  const time = parseTimeInput(values.duration)
                  if (!time) {
                    form.setError("duration", { type: "validate", message: "Use HH:MM" })
                    return
                  }
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <DatePicker value={field.value} onChange={field.onChange} className="h-11 rounded-2xl" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
